...
public class RedisDataService {
    ...
    public RedisDataService(RedisTemplate redisTemplate, StringRedisTemplate stringRedisTemplate) {
        ...
        this.stringRedisTemplate.setHashValueSerializer(new JdkSerializationRedisSerializer());
    }
     ...
     * @return true成功 false失败
     */
    public boolean setNum(String key, long value) {
        try {
     ...
     * @return
     */
    public long incrNum(String key, long delta) {
        if (delta < 0) {
     ...
     * @return
     */
    public long decrNum(String key, long delta) {
        if (delta < 0) {
